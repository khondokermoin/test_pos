         ...
         <div class="d-flex align-items-center gap-2">
             ...
             <a href="index.html" class="logo">
                 <span class="logo-light">
                     <span class="logo-lg"><img src="{{ asset('') }}frontend_assets/images/logo.png"
                             alt="logo"></span>
             ...
             <div class="topbar-item d-none d-md-flex">
                 <div class="dropdown">
                     <a href="" class="topbar-link btn btn-link px-2 dropdown-toggle drop-arrow-none fw-medium"
                         data-bs-toggle="dropdown" data-bs-trigger="hover" data-bs-offset="0,17" aria-haspopup="false"
                         aria-expanded="false">
                             ...
                             <div class="col-md-4">
                                 <div class="p-3">
                                     ...
                                     <ul class="list-unstyled megamenu-list">
                                         ...
                                         <li>
                                             <a href="javascript:void(0);">Dragula</a>
                                         </li>
                                         <li>
                             ...
                             <div class="col-md-4">
                                 <div class="p-3">
                                     ...
                                     <ul class="list-unstyled megamenu-list">
                                         ...
                                         <li>
                                             <a href="javascript:void(0);">Kanban Board</a>
                                         </li>
                                         <li>
                                             <a href="javascript:void(0);">Invoice Management</a>
                                         </li>
                                         <li>
             ...
             <div class="topbar-item">
                 <div class="dropdown">
                     <button class="topbar-link" data-bs-toggle="dropdown" data-bs-offset="0,25" type="button"
                         ...
                         <img src="{{ asset('') }}frontend_assets/images/flags/us.svg" alt="user-image"
                     ...
                     <div class="dropdown-menu dropdown-menu-end">
                         ...
                         <a href="javascript:void(0);" class="dropdown-item" data-translator-lang="hi">
                             <img src="{{ asset('') }}frontend_assets/images/flags/in.svg" alt="user-image"
                                 class="me-1 rounded" height="18" data-translator-image> <span
                         ...
                         <a href="javascript:void(0);" class="dropdown-item">
                             <img src="{{ asset('') }}frontend_assets/images/flags/de.svg" alt="user-image"
                                 class="me-1 rounded" height="18"> <span class="align-middle">German</span>
                         </a>

                         <!-- item-->
                         <a href="javascript:void(0);" class="dropdown-item">
                             <img src="{{ asset('') }}frontend_assets/images/flags/it.svg" alt="user-image"
                                 class="me-1 rounded" height="18"> <span class="align-middle">Italian</span>
                         </a>

                         <!-- item-->
                         <a href="javascript:void(0);" class="dropdown-item">
                             <img src="{{ asset('') }}frontend_assets/images/flags/es.svg" alt="user-image"
                                 class="me-1 rounded" height="18"> <span class="align-middle">Spanish</span>
                         </a>

                         <!-- item-->
                         <a href="javascript:void(0);" class="dropdown-item">
                             <img src="{{ asset('') }}frontend_assets/images/flags/ru.svg" alt="user-image"
             ...
             <div class="topbar-item">
                 <div class="dropdown">
                     <button class="topbar-link dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown"
                         data-bs-offset="0,23" type="button" data-bs-auto-close="outside" aria-haspopup="false"
                         aria-expanded="false">
                     ...
                     <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg fs-13">
                         ...
                         <div class="position-relative z-2 shadow-none rounded-0" style="max-height: 300px;"
                             data-simplebar>
                             <!-- item-->
                             ...
                             <div class="dropdown-item notification-item py-2 text-wrap" id="notification-2">
                                 <span class="d-flex align-items-center">
                                     <span class="me-2 position-relative flex-shrink-0">
                                         <img src="{{ asset('') }}frontend_assets/images/users/avatar-4.jpg"
                             ...
                             <div class="dropdown-item notification-item py-2 text-wrap" id="notification-4">
                                 <span class="d-flex align-items-center">
                                     <span class="me-2 position-relative flex-shrink-0">
                                         <img src="{{ asset('') }}frontend_assets/images/users/avatar-7.jpg"
                                             class="avatar rounded-circle" alt="" />
                                     </span>
                                     <span class="flex-grow-1 text-muted">
                             ...
                             <div class="dropdown-item notification-item py-2 text-wrap" id="notification-5">
                                 <span class="d-flex align-items-center">
                                     <span class="me-2 position-relative flex-shrink-0">
                                         <img src="{{ asset('') }}frontend_assets/images/users/avatar-10.jpg"
                                             class="avatar rounded-circle" alt="" />
                                     </span>
                                     <span class="flex-grow-1 text-muted">
                     ...
                     <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg p-0">
                         <div class="p-2">
                             <div class="row g-0">
                                 <div class="col">
                                     <a class="dropdown-icon-item" href="#">
                                         <img src="{{ asset('') }}frontend_assets/images/brands/slack.svg"
                                             alt="slack">
                                         <span>Slack</span>
                                     </a>
                                 </div>
                                 <div class="col">
                                     <a class="dropdown-icon-item" href="#">
                                         <img src="{{ asset('') }}frontend_assets/images/brands/gitlab.svg"
                                             alt="Github">
                                         <span>Gitlab</span>
                                     </a>
                                 </div>
                                 <div class="col">
                                     <a class="dropdown-icon-item" href="#">
                                         <img src="{{ asset('') }}frontend_assets/images/brands/dribbble.svg"
                                             alt="dribbble">
                                         <span>Dribbble</span>
                                     </a>
                                 </div>
                             ...
                             <div class="row g-0">
                                 <div class="col">
                                     <a class="dropdown-icon-item" href="#">
                                         <img src="{{ asset('') }}frontend_assets/images/brands/bitbucket.svg"
                                             alt="bitbucket">
                                         <span>Bitbucket</span>
                                     </a>
                                 </div>
                                 <div class="col">
                                     <a class="dropdown-icon-item" href="#">
                                         <img src="{{ asset('') }}frontend_assets/images/brands/dropbox.svg"
                                             alt="dropbox">
                                         <span>Dropbox</span>
                                     </a>
                                 </div>
                                 <div class="col">
                                     <a class="dropdown-icon-item" href="#">
                                         <img src="{{ asset('') }}frontend_assets/images/brands/google-cloud.svg"
                                             alt="G Suite">
                                         <span>G Cloud</span>
                                     </a>
                                 </div>
             ...
             <div class="topbar-item nav-user">
                 <div class="dropdown">
                     <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                         ...
                         <img src="{{ asset('') }}frontend_assets/images/users/avatar-1.jpg" width="32"
                             class="rounded-circle me-lg-2 d-flex" alt="user-image">
                         <span class="d-lg-flex flex-column gap-1 d-none">
                             <h5 class="my-0 fs-13 fw-semibold">Alex K.</h5>
                         </span>
